...
describe('Service Tests', () => {
  describe('Evento Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Evento(0, 'AAAAAAA', 'AAAAAAA', currentDate, currentDate, 'AAAAAAA', 'image/png', 'AAAAAAA');
    });
        ...
        const returnedFromService = Object.assign(
          {
            ...
            dataDoEvento: currentDate.format(DATE_FORMAT)
          },
          elemDefault
        );
        service
