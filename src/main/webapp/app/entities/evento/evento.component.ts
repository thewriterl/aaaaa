...
export class EventoComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.eventoService
      ...
      .subscribe((res: HttpResponse<IEvento[]>) => this.paginateEventos(res.body, res.headers));
  }
  ...
  registerChangeInEventos() {
    this.eventSubscriber = this.eventManager.subscribe('eventoListModification', () => this.loadAll());
  }
